...
const WorldClassTopicCard: React.FC<WorldClassTopicCardProps> = ({
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    ...
    // Open Google search in a new tab instead of calling onClick
    const searchQuery = encodeURIComponent(`${topicDisplay.topic.name} site:news.google.com`);
  ...
  return (
    <>
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label={`Buscar noticias sobre ${topicDisplay.displayText} en Google`}
        onKeyDown={(e) => {
      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-center justify-between bg-blue-50 dark:bg-blue-900 rounded-lg p-2 border border-blue-200 dark:border-blue-800">
            <div className="flex items-center space-x-2 text-blue-600 dark:text-blue-400">
              ...
              <span className="text-xs font-medium">Click para buscar en Google</span>
            </div>
            <FaArrowRight className="text-blue-400 text-xs transform group-hover:translate-x-1 transition-transform" />
          </div>
