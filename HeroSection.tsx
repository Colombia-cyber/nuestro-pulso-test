...
const HeroSection: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-r from-yellow-400 via-blue-500 to-red-500 h-screen flex items-center justify-center">
      <div className="absolute inset-0 bg-white bg-opacity-30 backdrop-blur-lg rounded-lg p-8 mx-4 max-w-4xl text-center">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <button className="px-6 py-3 bg-yellow-600 text-white rounded-lg shadow-lg hover:bg-yellow-700 transition">
            Take Survey
          </button>
        </div>
      </div>
