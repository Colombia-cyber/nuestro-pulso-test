    ...
    <div className="relative bg-gradient-to-r from-yellow-400 via-blue-500 to-red-500 min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <button 
            onClick={() => window.location.hash = 'congress'}
            className="bg-white bg-opacity-20 backdrop-blur-lg rounded-xl p-6 border border-white border-opacity-30 hover:bg-opacity-30 transition-all transform hover:scale-105"
          >
