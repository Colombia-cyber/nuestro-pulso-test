    ...
    <nav className="fixed top-0 left-0 right-0 bg-gradient-to-r from-yellow-400 via-blue-500 to-red-500 shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* User Actions */}
          <div className="flex items-center space-x-2">
            <button className="bg-white/20 text-white px-3 py-1 rounded-md text-sm hover:bg-white/30 transition-colors">
              Iniciar Sesión
            </button>
            <button className="bg-white text-blue-600 px-3 py-1 rounded-md text-sm hover:bg-gray-100 transition-colors">
              Registrarse
            </button>
          </div>
        </div>
