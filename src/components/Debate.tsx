...
const Debate: React.FC = () => {
  ...
  const debates = [
    {
      id: 1,
      title: 'Reforma Tributaria 2024: ¿Progreso o Retroceso?',
      status: 'En vivo',
      participants: 1250,
      timeLeft: '2:45:30',
      topic: 'Política Fiscal',
      sides: {
        favor: { count: 678, percentage: 54 },
        contra: { count: 572, percentage: 46 }
      },
      arguments: [
        {
          side: 'favor',
          author: 'Dr. Eduardo Ramírez',
          credential: 'Economista UNAL',
          text: 'La reforma tributaria propuesta aumentará los recursos para inversión social y reducirá la desigualdad.',
          votes: 234,
          time: '14:30'
        },
        {
          ...
          credential: 'Tributarista PUJ',
          text: 'Los nuevos impuestos afectarán desproporcionalmente a la clase media y limitarán el crecimiento económico.',
          votes: 198,
          time: '14:32'
        }
      ]
    ...
    {
      id: 2,
      title: 'Transporte Público en Bogotá: Soluciones Innovadoras',
      status: 'Próximamente',
      participants: 0,
      startTime: '19:00',
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span>{debates[0].sides.favor.percentage}%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-green-500 h-2 rounded-full" 
                    style={{ width: `${debates[0].sides.favor.percentage}%` }}
                  ></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span>{debates[0].sides.contra.percentage}%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-red-500 h-2 rounded-full" 
                    style={{ width: `${debates[0].sides.contra.percentage}%` }}
                  ></div>
                </div>
              </div>
            </div>
