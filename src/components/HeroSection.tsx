      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div 
            ...
            className="bg-white bg-opacity-20 backdrop-blur-lg rounded-xl p-6 border border-white border-opacity-30 cursor-pointer hover:bg-opacity-30 transition-all duration-200"
          >
